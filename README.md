...
- **V2.0.0 (2024-06-20)**:
  ...
  - 改善錯誤處理和例外管理
=======
本專案為 K9 automatic ppm criterion highlight system V2.0.0，和上一個版本相比，修改了整體的系統架構以及資源處理，大幅優化了整體速度。此系統是一個自動化的 PPM（Parts Per Million）標準突出顯示系統，專為機鑽品質監控而設計。系統整合了 AI 圖像分類、品質資料分析、自動警報通知等功能，能夠即時監控機鑽過程的品質狀況並自動發送警告。
>>>>>>> fe21914b04071646dc10b8b82fa7de7cf9aa9841
